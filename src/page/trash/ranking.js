...
const TrashRanking = ({match}) =>{
	return (
			<div>
				...
				>
					 <Menu.Item key="1"><Link to="/home/trashRanking/househlodRanking">住户排名</Link></Menu.Item>
					 <Menu.Item key="2"><Link to="/home/trashRanking/vliiageRanking">村排名</Link></Menu.Item>
					 <Menu.Item key="3"><Link to="/home/trashRanking/townRanking">镇排名</Link></Menu.Item>
			</Menu>
			<div>

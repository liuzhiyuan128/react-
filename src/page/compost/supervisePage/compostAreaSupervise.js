...
const hurry = () => {
   ...
   let limitTime = '';
    Modal.confirm({
        ...
        cancelText: '取消',
        onOk: () => {
            if(!limitTime) return message.warning("请输入必填项")
            ajax({
                url: 'areaPressdo',
                type: "post",
                data: qs.stringify({
...
class CompostAreaSupervise extends Component {
    constructor(props) {
        super(props);
        vm = this
        this.state = {
...
const compostAreaSupervise = () => {
    return <CompostAreaSupervise/>
}

export default compostAreaSupervise